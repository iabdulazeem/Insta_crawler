"""
Django settings for indow_backend project.
...
SECRET_KEY = 'x-q-p&h^(v#@o8@n#!xml%$1pa%qggo9$j75-l@o#-hrt5hq!l'
...
ROOT_URLCONF = 'indow_backend.urls'
...
WSGI_APPLICATION = 'indow_backend.wsgi.application'
